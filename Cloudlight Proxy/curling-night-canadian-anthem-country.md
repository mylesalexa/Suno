# Curling Night *(a Canadian anthem)*

*A proud, sweeping honky-tonk anthem about curling as a shared national pastime — not a party-night song
...
> This one should feel classic, proud, honky-tonk, coast-to-coast.

---

## Researching the style
- **"Canadian Girls" (Dean Brody)** → a **honky-tonk** country hit, #1 on Canadian country radio, written
  explicitly as a proud, patriotic tribute (Canada's answer to "California Girls"). Warm country twang,
  chart-topping singalong energy, classic guitar-and-fiddle production rather than a modern dance-pop
  fusion.
- **The translation for this song:** the same honky-tonk warmth and patriotic pride, redirected from a
  tribute-to-women song into a tribute-to-a-pastime song — curling as something every corner of the country
  shares, not one wild party night.
...
## Style / Tempo / Vocal
**Genre:** honky-tonk country anthem — warm country twang, fiddle, pedal steel, acoustic and electric
guitar, classic radio-country production. Proud, patriotic, big singalong energy — no club beat, no 808, no
dance-floor drop.

- **Tempo:** ~**112 BPM** (uptempo honky-tonk, built for a singalong, not a dance floor).
- **Key:** **G major** (bright, proud, anthem-ready).
- **Vocal:** warm, proud **male lead** — classic country delivery, big and full on the chorus, tight
  harmonies. Clean.

---

## The Panel (Canadian anthem read)
*Criteria: **Hook · Singalong · Patriotic Pride · Relatability · Chart/Production** (10 each, 50/judge, 250).*
- **Cole Sutton** (Nashville producer) · **Dwight Boone** (country radio PD) · **Reggie "Tailgate" Holt**
  (festival DJ) · **Maya (17)** (Gen-Z) · **Skip Dyer** (playlist editor).

| Judge | Hook | Singalong | Pride | Relatable | Chart | Total | Note |
|---|---|---|---|---|---|---|---|
...
after the game. This is the anthem before it — same sport, completely different room."*
...
```
Honky-tonk country anthem, 112 BPM, key of G, warm country twang, fiddle, pedal steel, acoustic and electric guitar, proud patriotic energy, male lead, big singalong chorus, radio country
```

**Exclude Styles box (optional)**
```
explicit, profanity, EDM, dance-pop, 808, club beat, trap, rap, metal, screamo, dark, aggressive, sad, monotone
```

**Lyrics box (paste exactly)**
```
[Intro]
(warm fiddle intro, crowd murmur, rink ambience)
...
It's just who we are, and it's all we know
From the flatland towns to the mountain shore
This is who we've always been, and so much more

[Chorus]
This is curling country, coast to coast
Every little rink's got a story to boast
Broom in hand since before we could walk
Hurry hard is how we talk
This is curling country, proud and true
Maple leaf on every sweater too
From the prairie wheat to the ocean line
...
[Outro]
(warm, proud, fading)
This is curling country...
Coast to coast, forever ours
```
...
Honky-tonk country anthem, 112 BPM, key of G, warm country twang, fiddle, pedal steel, acoustic and electric guitar, proud patriotic energy, male lead, big singalong chorus, radio country
```
**Tip:** `honky-tonk` + `warm country twang` are what keep this out of the modern-dance-fusion lane its
sibling lives in — no `808`, no `club beat`, no `EDM`. `proud patriotic energy` is doing real work; if it
comes out too laid-back, add `anthemic, stadium-singalong, big harmonies`. Keep `fiddle` and `pedal steel`
up front so it reads as classic country, not pop-country.

## Variations
- **Companion set:** the party-night curling song lives in `hurry-hard-bonspiel-night-country.md` (modern
  country-pop dance) — this is the proud/anthem cousin (honky-tonk), same sport, different room entirely.
- **Bigger crowd moment:** tag `(stadium crowd sings)` on the final chorus and add `arena reverb, massed choir`.
- **More stripped/traditional:** drop to ~100 BPM, `acoustic, fiddle-forward, front-porch` for a leaner classic-country cut.
- **Title/hook swaps:** "This Is Curling Country," "Coast to Coast," "Hurry Hard Is How We Talk," "Ours Alone."
